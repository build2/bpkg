...
namespace odb
{
  ...
  struct query_columns< ::bpkg::selected_package, id_sqlite, A >
  {
    ...
    sqlite::query_column<
      sqlite::value_traits<
        ...
        sqlite::id_integer >::query_type,
      sqlite::id_integer >
    has_constraint_type_;

    static const has_constraint_type_ has_constraint;
  };
  ...
  template <typename A>
  const typename query_columns< ::bpkg::selected_package, id_sqlite, A >::has_constraint_type_
  query_columns< ::bpkg::selected_package, id_sqlite, A >::
  has_constraint (A::table_name, "\"has_constraint\"", 0);
    ...
    public access::object_traits< ::bpkg::selected_package >
  {
    ...
    struct image_type
    {
      ...
      // has_constraint
      //
      long long has_constraint_value;
      bool has_constraint_null;
