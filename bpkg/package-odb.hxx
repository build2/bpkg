...
namespace odb
{
  ...
  struct query_columns< ::bpkg::configuration, id_sqlite, A >
  {
    ...
    sqlite::query_column<
      sqlite::value_traits<
        ::odb::wrapper_traits< ::bpkg::optional_uint64_t >::wrapped_type,
    ...
    // uuid
    //
    struct uuid_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;

      static void
      append (sqlite::query_base& q,
              sqlite::val_bind< ::butl::uuid > v,
              const char* conv)
      {
    ...
    public access::object_traits< ::bpkg::configuration >
  {
    ...
    static std::shared_ptr<prepared_query_impl>
    prepare_query (connection&, const char*, const query_base_type&);

    static std::shared_ptr<result_impl>
  ...
  struct query_columns< ::bpkg::repository_fragment, id_sqlite, A >
  {
    ...
    struct location_class_
    {
      ...
      // type
      //
      struct type_base_type_: sqlite::query_column_base
      {
        using query_column_base::query_column_base;

        static void
        append (sqlite::query_base& q,
                sqlite::val_bind< ::bpkg::repository_type > v,
                const char* conv)
        {
  ...
  struct query_columns< ::bpkg::available_package, id_sqlite, A >
  {
    ...
    struct version_class_
    {
      ...
      sqlite::query_column<
        sqlite::value_traits<
          ::odb::wrapper_traits< ::bpkg::optional_string >::wrapped_type,
          sqlite::id_text >::query_type,
        sqlite::id_text >
      release_type_;
  ...
  class access::composite_value_traits< ::bpkg::prerequisite_info, id_sqlite >
  {
    ...
    struct image_type
    {
      ...
      // version_constraint
      //
      composite_value_traits< ::bpkg::version_constraint, id_sqlite >::image_type version_constraint_value;
  ...
  struct query_columns< ::bpkg::selected_package, id_sqlite, A >
  {
    ...
    // state
    //
    struct state_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;

      static void
      append (sqlite::query_base& q,
              sqlite::val_bind< ::bpkg::package_state > v,
              const char* conv)
      {
    ...
    // substate
    //
    struct substate_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;

      static void
      append (sqlite::query_base& q,
              sqlite::val_bind< ::bpkg::package_substate > v,
              const char* conv)
      {
    ...
    // archive
    //
    struct archive_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;

      static void
      append (sqlite::query_base& q,
              sqlite::val_bind< ::butl::path > v,
              const char* conv)
      {
        // From package-common.hxx:72:14
        ::std::string const& vt =
          (v.val).representation ();

        q.append<
          ::odb::wrapper_traits< ::bpkg::optional_string >::wrapped_type,
          sqlite::id_text > (
            sqlite::val_bind< ::odb::wrapper_traits< ::bpkg::optional_string >::wrapped_type > (vt),
            conv);
      }
      ...
      append (sqlite::query_base& q,
        ...
        -> typename std::enable_if<
             std::is_reference< decltype (
                 // From package-common.hxx:72:14
                 (r.ref).representation ()) >::value>::type
      {
        // From package-common.hxx:72:14
        ::std::string const& rt =
          (r.ref).representation ();

        q.append<
          ::odb::wrapper_traits< ::bpkg::optional_string >::wrapped_type,
          sqlite::id_text > (
            sqlite::ref_bind< ::odb::wrapper_traits< ::bpkg::optional_string >::wrapped_type > (rt),
            conv);
      }
    ...
    // src_root
    //
    struct src_root_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
    ...
    // out_root
    //
    struct out_root_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
    ...
    sqlite::query_column<
      sqlite::value_traits<
        ...
        sqlite::id_integer >::query_type,
      sqlite::id_integer >
    has_dependency_constraint_type_;

    static const has_dependency_constraint_type_ has_dependency_constraint;
  };
  ...
  template <typename A>
  const typename query_columns< ::bpkg::selected_package, id_sqlite, A >::has_dependency_constraint_type_
  query_columns< ::bpkg::selected_package, id_sqlite, A >::
  has_dependency_constraint (A::table_name, "\"has_dependency_constraint\"", 0);
    ...
    public access::object_traits< ::bpkg::selected_package >
  {
    ...
    struct image_type
    {
      ...
      // has_dependency_constraint
      //
      long long has_dependency_constraint_value;
      bool has_dependency_constraint_null;
  ...
  struct query_columns< ::bpkg::certificate, id_sqlite, A >
  {
    ...
    // start_date
    //
    struct start_date_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;

      static void
      append (sqlite::query_base& q,
              sqlite::val_bind< ::butl::timestamp > v,
              const char* conv)
      {
    ...
    // end_date
    //
    struct end_date_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
  ...
  // complements
  //
  struct access::object_traits_impl< ::bpkg::repository_fragment, id_sqlite >::
  complements_traits
  {
    static const std::size_t id_column_count = 1UL;
  ...
  // fragments
  //
  struct access::object_traits_impl< ::bpkg::repository, id_sqlite >::
  fragments_traits
  {
    static const std::size_t id_column_count = 1UL;
  ...
  // languages
  //
  struct access::object_traits_impl< ::bpkg::available_package, id_sqlite >::
  languages_traits
  {
    static const std::size_t id_column_count = 6UL;
  ...
  // prerequisites
  //
  struct access::object_traits_impl< ::bpkg::selected_package, id_sqlite >::
  prerequisites_traits
  {
    static const std::size_t id_column_count = 1UL;
    static const std::size_t data_column_count = 22UL;
