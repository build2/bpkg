...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--config-uuid\033[0m \033[4muuid\033[0m       Use the specified UUID as the configuration id instead" << ::std::endl
       << "                         of generating one automatically." << ::std::endl;
  ...
  struct _cli_cfg_create_options_map_init
  {
    _cli_cfg_create_options_map_init ()
    {
      ...
      _cli_cfg_create_options_map_["--config-uuid"] =
      &::bpkg::cli::thunk< cfg_create_options, uuid, &cfg_create_options::config_uuid_,
        &cfg_create_options::config_uuid_specified_ >;
    }
  };
...
namespace bpkg
{
  ...
  print_bpkg_cfg_create_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "specified with the \033[1m--config-uuid\033[0m option. This UUID is used to check the" << ::std::endl
       << "integrity of configuration links. For convenience of referring to linked" << ::std::endl
       << "configurations, a configuration can also be assigned a name with the \033[1m--name\033[0m" << ::std::endl
       << "option." << ::std::endl
       << ::std::endl
