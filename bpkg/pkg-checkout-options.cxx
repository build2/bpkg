...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--output-purge\033[0m           Remove the checked out package (source) directory when" << ::std::endl
       << "                         the package is purged." << ::std::endl;
  ...
  struct _cli_pkg_checkout_options_map_init
  {
    _cli_pkg_checkout_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_checkout_options, bool, &pkg_checkout_options::output_purge_ >;
    }
  };
