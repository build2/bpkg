...
namespace bpkg
{
  ...
  merge (const rep_fetch_options& a)
  {
    ...
    if (a.no_dir_progress_)
    {
      ::bpkg::cli::parser< bool>::merge (
        this->no_dir_progress_, a.no_dir_progress_);
    }
  }
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--no-dir-progress\033[0m         Do not print progress for the specified" << ::std::endl
       << "                          directory-based repositories." << ::std::endl;
  ...
  struct _cli_rep_fetch_options_map_init
  {
    _cli_rep_fetch_options_map_init ()
    {
      ...
      _cli_rep_fetch_options_map_["--no-dir-progress"] =
      &::bpkg::cli::thunk< rep_fetch_options, &rep_fetch_options::no_dir_progress_ >;
    }
  };
...
namespace bpkg
{
  ...
  print_bpkg_rep_fetch_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "or complement of another repository not being fetched may result in an" << ::std::endl
