...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--relative\033[0m               Rebase the absolute linked configuration path relative" << ::std::endl
       << "                         to the current configuration directory." << ::std::endl;
  ...
  struct _cli_cfg_link_options_map_init
  {
    _cli_cfg_link_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< cfg_link_options, bool, &cfg_link_options::relative_ >;
    }
  };
...
namespace bpkg
{
  ...
  print_bpkg_cfg_link_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "configuration. See \033[1mbpkg-cfg-create(1)\033[0m for background on linked configurations." << ::std::endl
       << ::std::endl
       ...
       << "original configuration name is used to name the linked. If the link is unnamed," << ::std::endl
