...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--immediate\033[0m|\033[1m-i\033[0m            Also print the status of immediate dependencies and" << ::std::endl
       << "                          constraints." << ::std::endl;

    os << std::endl
       << "\033[1m--recursive\033[0m|\033[1m-r\033[0m            Also print the status of all dependencies and" << ::std::endl
       << "                          constraints, recursively." << ::std::endl;

    os << std::endl
       << "\033[1m--old-available\033[0m|\033[1m-o\033[0m        Print old available versions." << ::std::endl;

    os << std::endl
       << "\033[1m--constraint\033[0m              Print version constraints for dependencies and" << ::std::endl
       << "                          constraints." << ::std::endl;
...
namespace bpkg
{
  ...
  print_bpkg_pkg_status_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "Additionally, the status of immediate or all dependencies and dependency" << ::std::endl
       << "constraints of the above packages can be printed by specifying the" << ::std::endl
       << "\033[1m--immediate\033[0m|\033[1m-i\033[0m\033[0m or \033[1m--recursive\033[0m|\033[1m-r\033[0m\033[0m options, respectively. The dependency" << ::std::endl
       << "constraints, however, are never printed recursively. Note that the status is" << ::std::endl
       ...
       << ::std::endl
       << "In lines corresponding to dependency constraints the package name is printed" << ::std::endl
       << "prefixed with '\033[1m?\033[0m'." << ::std::endl
       << ::std::endl
       ...
       << ::std::endl
       << "Another example of the status output this time including dependencies and" << ::std::endl
       << "constraints:" << ::std::endl
       << ::std::endl
       ...
       << "  optional<string>          version_constraint;" << ::std::endl
       ...
       << "  vector<package_status>    constraints;" << ::std::endl
       << "};" << ::std::endl
       << ::std::endl
       ...
       << "\033[1mversion_constraint\033[0m member is present only if the \033[1m--constraint\033[0m option is" << ::std::endl
       << "specified. The \033[1mversion\033[0m member is absent if the \033[1mstatus\033[0m member is \033[1munknown\033[0m or" << ::std::endl
       << "\033[1mavailable\033[0m and no package version is specified on the command line. If the" << ::std::endl
       << "\033[1msub_status\033[0m member is \033[1msystem\033[0m, then the \033[1mversion\033[0m member can be special \033[1m*\033[0m. The" << ::std::endl
       << "\033[1mdependencies\033[0m and \033[1mconstraints\033[0m members are present only if the \033[1m--immediate|-i\033[0m or" << ::std::endl
       << "\033[1m--recursive|-r\033[0m options are specified." << ::std::endl
       << ::std::endl
