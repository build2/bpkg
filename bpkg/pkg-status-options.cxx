...
namespace bpkg
{
  ...
  merge (const pkg_status_options& a)
  {
    ...
    if (a.version_constraint_)
    {
      ::bpkg::cli::parser< bool>::merge (
        this->version_constraint_, a.version_constraint_);
    }
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--version-constraint\033[0m      Print version constraints for dependencies and" << ::std::endl
       << "                          constraints." << ::std::endl;
  ...
  struct _cli_pkg_status_options_map_init
  {
    _cli_pkg_status_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_status_options, &pkg_status_options::old_available_ >;
      _cli_pkg_status_options_map_["--version-constraint"] =
      &::bpkg::cli::thunk< pkg_status_options, &pkg_status_options::version_constraint_ >;
...
namespace bpkg
{
  ...
  print_bpkg_pkg_status_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "Lines corresponding to dependency constraints will have the package name" << ::std::endl
       ...
       << "\033[1mversion_constraint\033[0m member is present only if the \033[1m--version-constraint\033[0m option is" << ::std::endl
