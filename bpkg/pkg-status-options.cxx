...
namespace bpkg
{
  ...
  print_bpkg_pkg_status_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "line starts with the package name and version (if specified) followed by one of" << ::std::endl
       << "the status words listed below. Some of them can be optionally followed by '\033[1m,\033[0m'" << ::std::endl
       << "(no spaces) and a sub-status word. Lines corresponding to dependencies from" << ::std::endl
       << "linked configurations will additionally mention the configuration directory in" << ::std::endl
       << "square brackets after the package name and version." << ::std::endl
       << ::std::endl
