...
namespace bpkg
{
  ...
  cfg_create (const cfg_create_options& o, cli::scanner& args)
  {
    ...
    // Add the special, self configuration object.
    //
    // Note that this object captures information about the current
    // configuration. This information will potentially be pulled into the
    // other configurations, which this configuration will be associated with
    // later.
    //
