...
namespace bpkg
{
  ...
  print_bpkg_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mEXIT STATUS\033[0m" << ::std::endl
       ...
       << ::std::endl
       << "The \033[1mBPKG_FETCH_CACHE\033[0m, \033[1mBPKG_FETCH_CACHE_PATH\033[0m, and \033[1mBPKG_FETCH_CACHE_SESSION\033[0m can" << ::std::endl
       << "be used to control local caching of downloaded resources (packages, repository" << ::std::endl
       << "metadata, etc). See the description of the \033[1m--fetch-cache*\033[0m options in" << ::std::endl
       << "\033[1mbpkg-common-options(1)\033[0m for details on their semantics." << ::std::endl
       << ::std::endl
