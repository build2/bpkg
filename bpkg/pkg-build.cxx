  ...
  pkg_build (const pkg_build_options& o, cli::group_scanner& args)
  {
    ...
    vector<pkg_spec> specs;
    {
      ...
      while (args.more ())
      {
        ...
        //
        // @@ Make some sanity checks and fail for other visibility modifiers
        //    (% and /; see build2::context::parse_variable_override() for
        //    details). But first we need to decide if we allow scope-specific
        //    variables or ban them as well (probably with some transitional
        //    period when we just strip the .../ scope). When done, also
        //    change pkg-configure correspondingly.
        //
