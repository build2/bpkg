...
namespace bpkg
{
  ...
  print_bpkg_cfg_info_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSYNOPSIS\033[0m" << ::std::endl
       ...
       << "type, name, and mode. The mode is only printed if specified. If the \033[1m--link\033[0m" << ::std::endl
       << "and/or \033[1m--backlink\033[0m options are specified, then this information is also printed" << ::std::endl
       << "for each linked and/or implicitly backlinked configuration, if any. Note that" << ::std::endl
       << "the dangling implicit backlinks are silently skipped, unless \033[1m--dangling\033[0m is" << ::std::endl
       << "specified, in which case this information is also printed for them.  Note that" << ::std::endl
       << "the information is written to \033[1mstdout\033[0m, not \033[1mstderr\033[0m." << ::std::endl
       << ::std::endl
       ...
       << "name: foo" << ::std::endl
       << "mode: fetch-cache=false" << ::std::endl
       << ::std::endl
