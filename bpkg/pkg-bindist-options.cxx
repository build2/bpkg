...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mARCHIVE DESCRIPTION\033[0m" << ::std::endl
       ...
       << "Relocatable Installation (b#install-reloc) for details)." << ::std::endl
       << ::std::endl
       << "Another mechanism that can be useful when generating archive packages is the" << ::std::endl
...
namespace bpkg
{
  ...
  print_bpkg_pkg_bindist_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << "\033[1mSTRUCTURED RESULT\033[0m" << ::std::endl
       ...
       << "  optional<string> language_runtimes;" << ::std::endl
       ...
       << ::std::endl
       << "The \033[1mpackage::language_runtimes\033[0m member is absent if the language runtimes are" << ::std::endl
       << "not deduced for the distribution. Currently, they are only deduced for the" << ::std::endl
       << "\033[1marchive\033[0m distribution (see the \033[1m--archive-lang*\033[0m options for details). If present," << ::std::endl
       << "contains the dash-separated list of the language runtime ids." << ::std::endl;
