...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--all-pattern\033[0m \033[4mpattern\033[0m    Update held packages that match the specified wildcard" << ::std::endl
  ...
  struct _cli_pkg_update_options_map_init
  {
    _cli_pkg_update_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_update_options, bool, &pkg_update_options::immediate_ >;
      _cli_pkg_update_options_map_["-i"] =
      &::bpkg::cli::thunk< pkg_update_options, bool, &pkg_update_options::immediate_ >;
      _cli_pkg_update_options_map_["--recursive"] =
      &::bpkg::cli::thunk< pkg_update_options, bool, &pkg_update_options::recursive_ >;
