...
namespace odb
{
    ...
    struct end_date_base_type_: sqlite::query_column_base
    {
              ...
              const char* conv)
      {
        ...
        q.append<
          ...
          sqlite::id_integer > (
            sqlite::val_bind< ::odb::wrapper_traits< ::bpkg::optional_uint64_t >::wrapped_type > (vt),
            conv);
      }
                 ...
                 std::chrono::duration_cast < std::chrono::nanoseconds > ((r.ref).time_since_epoch ()).count ()) >::value>::type
      {
        ...
        q.append<
          ::odb::wrapper_traits< ::bpkg::optional_uint64_t >::wrapped_type,
          sqlite::id_integer > (
            sqlite::ref_bind< ::odb::wrapper_traits< ::bpkg::optional_uint64_t >::wrapped_type > (rt),
            conv);
      }
  ...
  struct query_columns< ::bpkg::pkg_repository_metadata, id_sqlite, A >
  {
    ...
    // directory
    //
    struct directory_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
    ...
    // access_time
    //
    struct access_time_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
    ...
    // repositories_path
    //
    struct repositories_path_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
    ...
    // packages_path
    //
    struct packages_path_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
  ...
  struct query_columns< ::bpkg::shared_source_directory, id_sqlite, A >
  {
    ...
    // src_root_file
    //
    struct src_root_file_base_type_: sqlite::query_column_base
    {
      using query_column_base::query_column_base;
  ...
  // untracked_configurations
  //
  struct access::object_traits_impl< ::bpkg::shared_source_directory, id_sqlite >::
  untracked_configurations_traits
  {
    static const std::size_t id_column_count = 6UL;
