...
namespace bpkg
{
            ...
            bool first) -> binary_files
  {
    ...
    // private, then in the --recursive auto and full modes we will install
    // all the data, documentation, and legal files, already organized into
    // their <project> subdirectories, into an additional subdirectory, named
    // as the bpkg package. To keep things consistent we use the bpkg package
