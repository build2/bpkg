...
namespace bpkg
{
  ...
  inline const strings& pkg_bindist_common_options::
  recursive () const
  {
  ...
  inline const size_t& pkg_bindist_archive_options::
  archive_strip_comps () const
  {
    return this->archive_strip_comps_;
  }

  inline bool pkg_bindist_archive_options::
  archive_strip_comps_specified () const
  {
    return this->archive_strip_comps_specified_;
  }
