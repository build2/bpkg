...
namespace bpkg
{
  ...
  // doesn't terminate in 2 seconds, then send SIGKILL and wait indefinitely.
  //
  static void
    ...
    try
    {
      ...
      if (!r || !*r)
      {
        ...
        dr << (r
               ...
               : "dnf makecache terminated: execution timeout expired");
    ...
    try
    {
      ...
      if (!r || !*r)
      {
        ...
        dr << (r
               ...
               : "dnf install terminated: execution timeout expired");
