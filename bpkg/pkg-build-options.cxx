...
namespace bpkg
{
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--config-name\033[0m \033[4mid\033[0m         Name of the linked configuration to build this" << ::std::endl
       << "                         package(s) in. By default, the package is built in the" << ::std::endl
       << "                         current configuration." << ::std::endl;

    os << std::endl
       << "\033[1m--config-id\033[0m \033[4mid\033[0m           Numeric id of the linked configuration to build this" << ::std::endl
       << "                         package(s) in. By default, the package is built in the" << ::std::endl
       << "                         current configuration." << ::std::endl;
  ...
  struct _cli_pkg_build_pkg_options_map_init
  {
    _cli_pkg_build_pkg_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_build_pkg_options, bool, &pkg_build_pkg_options::checkout_purge_ >;
      _cli_pkg_build_pkg_options_map_["--config-name"] =
      &::bpkg::cli::thunk< pkg_build_pkg_options, string, &pkg_build_pkg_options::config_name_,
        &pkg_build_pkg_options::config_name_specified_ >;
      _cli_pkg_build_pkg_options_map_["--config-id"] =
      &::bpkg::cli::thunk< pkg_build_pkg_options, uint64_t, &pkg_build_pkg_options::config_id_,
        &pkg_build_pkg_options::config_id_specified_ >;
      _cli_pkg_build_pkg_options_map_["--config-uuid"] =
      &::bpkg::cli::thunk< pkg_build_pkg_options, uuid, &pkg_build_pkg_options::config_uuid_,
  ...
  print_usage (::std::ostream& os, ::bpkg::cli::usage_para p)
  {
    ...
    os << std::endl
       << "\033[1m--no-refinement\033[0m          Don't try to refine the configuration by offering drop" << ::std::endl
       << "                         any unused dependencies that were potentially left" << ::std::endl
       << "                         behind on the previous \033[1mpkg-build\033[0m or \033[1mpkg-drop\033[0m command" << ::std::endl
       << "                         execution if the command is otherwise a noop (performs" << ::std::endl
       << "                         no new package builds, upgrades, etc)." << ::std::endl;
  ...
  struct _cli_pkg_build_options_map_init
  {
    _cli_pkg_build_options_map_init ()
    {
      ...
      &::bpkg::cli::thunk< pkg_build_options, bool, &pkg_build_options::no_refinement_ >;
    }
  };
